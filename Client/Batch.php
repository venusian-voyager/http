...
class Batch
{
     ...
     *
     * @var (\Closure($this, int|string, \Voyager\Http\Client\Response): void)|null
     */
     ...
     *
     * @var (\Closure($this, int|string, \Voyager\Http\Client\Response|\Voyager\Http\Client\RequestException|\Voyager\Http\Client\ConnectionException): void)|null
     */
     ...
     *
     * @var (\Closure($this, array<int|string, \Voyager\Http\Client\Response>): void)|null
     */
     ...
     *
     * @throws \Voyager\Http\Client\BatchInProgressException
     */
     ...
     *
     * @param  (\Closure($this, int|string, \Voyager\Http\Client\Response): void)  $callback
     * @return Batch
     */
     ...
     *
     * @param  (\Closure($this, int|string, \Voyager\Http\Client\Response|\Voyager\Http\Client\RequestException|\Voyager\Http\Client\ConnectionException): void)  $callback
     * @return Batch
     */
     ...
     *
     * @param  (\Closure($this, array<int|string, \Voyager\Http\Client\Response>): void)  $callback
     * @return Batch
     */
     ...
     *
     * @return \Voyager\NutsAndBolts\Defer\DeferredCallback
     */
     ...
     *
     * @return array<int|string, \Voyager\Http\Client\Response|\Voyager\Http\Client\RequestException>
     */
