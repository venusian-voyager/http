...
class Response implements ArrayAccess, Stringable
{
     ...
     *
     * @param  callable|(\Closure(\Voyager\Http\Client\Response): mixed)  $callback
     * @return $this
     */
     ...
     *
     * @return \Voyager\Http\Client\RequestException|null
     */
     ...
     *
     * @param  int|(\Closure(int, \Voyager\Http\Client\Response): bool)|callable  $statusCode
     * @return $this
     *
     * @throws \Voyager\Http\Client\RequestException
     */
